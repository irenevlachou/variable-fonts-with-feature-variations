...
It includes tips and insight about common problems. It builds upon [Travis Kochel's](https://github.com/scribbletone) [guide for variable fonts](https://github.com/scribbletone/i-can-variable-font) and [Miguel Sousa's](https://github.com/miguelsousa) documentation on [Adobe variable font prototype](https://github.com/adobe-fonts/adobe-variable-font-prototype).
